...
def main(wf):
    ...
    if api_key and folder_id:
        from llm.yandex import parse_task_with_llm
        import sys
        ...
        # Debug: print to stderr for Alfred debugger
        print(f"DEBUG: date={current_date}, weekday={current_weekday}", file=sys.stderr)
        ...
        if task_due_pretty:
            ...
            subtitle += " (configure YandexGPT for smart parsing)"
